    ...
    <section class="min-h-screen flex items-stretch text-white ">
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style="background-image: url(https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80);">
            ...
            <div class="w-full px-24 z-10">
                <h1 class="text-5xl font-bold text-left tracking-wide">Desperte o Potencial do Seu Conhecimento</h1>
                <p class="text-3xl my-4">Aprender é a chave para abrir portas de infinitas possibilidades.</p>
            </div>
            ...
            <div class="w-full py-6 z-20">
                ...
                @csrf
                    <div class="pb-2 pt-4">
                        ...
                        <label for="username" class="block mb-2 text-sm font-medium text-gray-300 dark:text-gray-300">Username</label>
                    ...
                    <div class="pb-2 pt-4">
                        ...
                        <label for="password" class="block mb-2 text-sm font-medium text-gray-300 dark:text-gray-300">Senha</label>
